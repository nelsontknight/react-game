"use strict";
var precacheConfig = [["/Clicky-Game/index.html", "ee18e3323893f5f1e3b098332a017d6e"],
["/Clicky-Game/static/css/main.aca8dd8f.css", "b4f3077f018e7a16f39b211fa11a9902"],
["/Clicky-Game/static/js/main.ade3ab57.js", "7b9f5bab39ccd0635003a79994887698"]],
    cacheName = "sw-precache-v3-sw-precache-webpack-plugin-" + (self.registration ? self.registration.scope : ""),
    ignoreUrlParametersMatching = [/^utm_/], addDirectoryIndex = function (e, t) {
        var n = new URL(e);
        return "/" === n.pathname.slice(-1) && (n.pathname += t), n.toString()
    },
    cleanResponse = function (t) { return t.redirected ? ("body" in t ? Promise.resolve(t.body) : t.blob()).then(function (e) { return new Response(e, { headers: t.headers, status: t.status, statusText: t.statusText }) }) : Promise.resolve(t) }, createCacheKey = function (e, t, n, r) {
        var a = new URL(e);
...
function setOfCachedUrls(e) {
        ...
        return setOfCachedUrls(r).then(function (n) {
            return Promise.all(Array.from(urlsToCacheKeys.values()).map(function (t) {
                if (!n.has(t)) {
                    ...
                    return fetch(e).then(function (e) { if (!e.ok) throw new Error("Request for " + t + " returned a response with status " + e.status); return cleanResponse(e).then(function (e) { return r.put(t, e) }) })
                }
            }))
        })
    ...
    self.addEventListener("fetch", function (t) {
        if ("GET" === t.request.method) {
            ...
            (e = urlsToCacheKeys.has(n)) || (n = addDirectoryIndex(n, r), e = urlsToCacheKeys.has(n)); var a = "/Clicky-Game/index.html";
